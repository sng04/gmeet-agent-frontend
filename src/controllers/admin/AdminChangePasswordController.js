...
/**
 * Loads the admin change-password template, validates challenge session,
 ...
 */
export default async function AdminChangePasswordController() {
  const container = await loadTemplate('/templates/admin/change-password.html', 'admin-change-password');
